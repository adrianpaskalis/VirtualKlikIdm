...
public class plnTest extends driverTest {
	...
	public	String testUrl; 
  	...
  	public void goToLoginPagePLN() throws InterruptedException{
  		VirtualTestReports.getTest().log(Status.INFO,"Go To Website for PLN Test");
		try {
	...
	public void testLoginPLN() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"Login Test for PLN Test");
		try { 
			objLogin  = new LoginPage(driver);
	...
	public void ValidateLogoCO() throws InterruptedException {
		VirtualTestReports.getTest().log(Status.INFO,"TS06-TC33 Validate Logo is Display On CheckOut Page");
		try {
	...
	public void ValidateTabKonfirmasiPesananCO() throws InterruptedException {
		VirtualTestReports.getTest().log(Status.INFO,"TS06-TC34 Validate Tab Konfirmasi Pesanan is Display On CheckOut Page");
		try {
			objCheckOutPage = new CheckoutPage(driver);
	...
	public void ValidateBoxImageCO() throws InterruptedException {
		VirtualTestReports.getTest().log(Status.INFO,"TS06-TC35 Validate Image Product is Display On CheckOut Page");
		try {
			objCheckOutPage = new CheckoutPage(driver);
	...
	public void ValidateDeleteProductCO() throws InterruptedException {
		VirtualTestReports.getTest().log(Status.INFO,"TS06-TC36 Validate Delete Product is Display On CheckOut Page");
		try {
			objCheckOutPage = new CheckoutPage(driver);
	...
	public void ValidateItemProductCO() throws InterruptedException {
		VirtualTestReports.getTest().log(Status.INFO,"TS06-TC37 Validate Item Product is Display On CheckOut Page");
		try {
			objCheckOutPage = new CheckoutPage(driver);
	...
	public void ValidateItemSubTotalCO() throws InterruptedException {
		VirtualTestReports.getTest().log(Status.INFO,"TS06-TC38 Validate Item SubTotal is Display On CheckOut Page");
		try {
			objCheckOutPage = new CheckoutPage(driver);
	...
	public void ValidateItemTotalCO() throws InterruptedException {
		VirtualTestReports.getTest().log(Status.INFO,"TS06-TC39 Validate Item Total is Display On CheckOut Page");
		try {
			objCheckOutPage = new CheckoutPage(driver);
	...
	public void ValidateItemCouponCO() throws InterruptedException {
		VirtualTestReports.getTest().log(Status.INFO,"TS06-TC40 Validate Item Coupon is Display On CheckOut Page");
		try {
			objCheckOutPage = new CheckoutPage(driver);
...
//	} 
	...
	public void validateSubTotalPC() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS07 -TC41 Valdiate Total Pembayaran PC Frame");
		try { 
	...
	public void validateIsaku() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS07 -TC42 Valdiate Isaku on PC Frame");
		try { 
			objPCFrame = new PaymentCenterPage(driver);
	...
	public void validateBCAVA() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS07 -TC44 Valdiate BCA VA PC Frame");
		try { 
			objPCFrame = new PaymentCenterPage(driver);
	...
	public void validateATM() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS07 -TC43 Valdiate Tranfer Via ATM PC Frame");
		try { 
			objPCFrame = new PaymentCenterPage(driver);
	...
	public void validateRekpon() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS07 -TC45 Valdiate CIMB Rekening Ponsel PC Frame");
		try { 
			objPCFrame = new PaymentCenterPage(driver);
	...
	public void validateSaldo() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS07 -TC46 Valdiate Saldo Pembayaran PC Frame");
		try { 
			objPCFrame = new PaymentCenterPage(driver);
	...
	public void PilihAlatBayar() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS07 - TC46 Choose Available Methods");
		try { 
			objPCFrame = new PaymentCenterPage(driver);
	...
	public void clickBayar() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS07 - TC46 Choose Available payment methods ");
		try { 
			objPCFrame = new PaymentCenterPage(driver);
	...
	public void validateHeaderTQPage() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC47 Validate Header Thankyou Page is Display");
		try { 
	...
	public void validateKetStatusTQPage() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC48 Validate Keterangan Status Thankyou Page is Display");
		try { 
	...
	public void validatePetunjukBayarTQPage() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC49 Validate Petunjuk Bayar Thankyou Page is Display");
		try { 
	...
	public void validateGoToOrderHistoryTQPage() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC50 Validate Link To OrderHistory Thankyou Page is Display");
		try { 
	...
	public void validateGoToHomePageTQPage() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC51 Validate Link To HomePage Thankyou Page is Display");
		try { 
	...
	public void validateRincianPembayaranTQPage() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC52 Validate Rincian Pembayaran Thankyou Page is Display");
		try { 
	...
	public void validateKodeBayarTQPage() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC53 Validate Kode Pembayaran Thankyou Page is Display");
		try { 
	...
	public void validateMetodeBayarTQPage() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC54 Validate Metode Pembayaran Thankyou Page is Display");
		try { 
	...
	public void validateTanggalPesanTQPage() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC55 Validate Tanggal Pesan Thankyou Page is Display");
		try { 
	...
	public void validateBatasPesanTQPage() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC56 Validate Batas Waktu Pesan Thankyou Page is Display");
		try { 
	...
	public void validateTotalBayarTQPage() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC57 Validate Total Bayar Thankyou Page is Display");
		try { 
	...
	public void validateBottomTQPage() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC58 Validate Bottom List Thankyou Page is Display");
		try { 
...
//	}
	...
	public void validateLogoOH() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC59 Validate Logo Order History is Display");
		try { 
	...
	public void validateDownloadAppOH() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC60 Validate Download App Order History is Display");
		try { 
	...
	public void validateFacebookOH() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC61 Validate Facebook App Order History is Display");
		try { 
	...
	public void validateInstagramOH() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC62 Validate Instagram App Order History is Display");
		try { 
	...
	public void validateCustomerCareOH() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC63 Validate Customer Care Order History is Display");
		try { 
	...
	public void validateDownloadAppCareOH() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC64 Validate Download Apps Order History is Display");
		try { 
	...
	public void validateIconOrderHistoryOH() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC65 Validate Icon Order History Order History is Display");
		try { 
	...
	public void validateItemSaldoOH() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC66 Validate item Saldo History is Display");
		try { 
	...
	public void validateProfileOH() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC67 Validate Profile is Display");
		try { 
	...
	public void validateiconRetailOH() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC68 Validate Icon Retail is Display");
		try { 
	...
	public void validateiconVirtualOH() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC69 Validate Icon Virtual is Display");
		try { 
	...
	public void validateiconTravelOH() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC70 Validate Icon Travel is Display");
		try { 
	...
	public void validateiconFoodOH() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC71 Validate Icon Food is Display");
		try { 
	...
	public void validateiconTiketOH() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC72 Validate Icon Tiket is Display");
		try { 
	...
	public void validateVirtualOrderHistoryOH() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC73 Validate Order History Virtual is Display");
		try { 
	...
	public void validateRetailOrderHistoryOH() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC74 Validate Order History Retail is Display");
		try { 
	...
	public void validateTravelOrderHistoryOH() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC75 Validate Order History Travel is Display");
		try { 
	...
	public void validateFoodOrderHistoryOH() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC76 Validate Order History Food is Display");
		try { 
	...
	public void validateTiketOrderHistoryOH() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC77 Validate Order History Tiket is Display");
		try { 
	...
	public void validateFilterKonfirmasi() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC78 Validate Filter Order History Konfirmasi ");
		try { 
	...
	public void validateFilterProses() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC79 Validate  Filter Order Proses");
		try { 
	...
	public void validateFilterBerhasil() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC80 Validate  Filter Order Berhasil");
		try { 
	...
	public void validateFilterGagal() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC81 Validate  Filter Order Gagal");
		try { 
	...
	public void validateFilterRefund() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC82 Validate  Filter Order Refund");
		try { 
	...
	public void validateFilterSemua() throws InterruptedException{
		VirtualTestReports.getTest().log(Status.INFO,"TS08 - TC83 Validate  Filter Order Refund");
		try { 
